 ...
 */
export type PaymentMethodType = "machina" | "tempo" | "stripe" | "card" | "lightning" | "x402" | "custom";
/**
 ...
 */
export declare const MCP_PAYMENT_REQUIRED_CODE = -32042;
/**
 * MCP payment metadata key for credential transport.
 * Credentials flow through `_meta['org.paymentauth/credential']`
 */
export declare const MCP_CREDENTIAL_META_KEY = "org.paymentauth/credential";
/**
...
export declare const MPP_HEADERS: {
    ...
    readonly CREDENTIAL: "x-mpp-credential";
    /** Challenge header (402 response) */
    readonly CHALLENGE: "x-mpp-challenge";
    /** Receipt header (response) */
    readonly RECEIPT: "x-mpp-receipt";
    /** MACHINA policy eval header */
    readonly POLICY_EVAL: "x-machina-policy-eval";
    /** Agent identity header */
    readonly AGENT_ID: "x-machina-agent-id";
    /** x402 compatibility header */
    readonly X402_PAYMENT: "x-402-payment";
};
